...
class Basic(models.Model):
    ...
    main_major = models.OneToOneField(Major, verbose_name='본전공', on_delete=models.SET_NULL, related_name='users_main', blank=True, null=True)
    double_major = models.OneToOneField(Major, verbose_name='이중전공', on_delete=models.SET_NULL, related_name='users_double', blank=True, null=True)
    minor_major = models.OneToOneField(Major, verbose_name='부전공', on_delete=models.SET_NULL, related_name='users_minor', blank=True, null=True)
...
class UserMajorCompulsory(models.Model):
    ...
    subject = models.OneToOneField(MajorCompulsory, on_delete=models.CASCADE, blank=True, null=True)
    user = models.ForeignKey(MyUser, on_delete=models.CASCADE)

# 교양필수과목
class UserLiberalCompulsory(models.Model):
    status = models.BooleanField(verbose_name='상태', blank=True, null=True)
    subject = models.OneToOneField(LiberalCompulsory, on_delete=models.CASCADE, blank=True, null=True)
    user = models.ForeignKey(MyUser, on_delete=models.CASCADE)
