"""
Django settings for deciduate project.
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=3),  # Access token 유효시간 3시간
    'REFRESH_TOKEN_LIFETIME': timedelta(days=7),  # Refresh token 유효시간 7일
