    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foreign_pass', models.IntegerField(choices=[(1, 'None'), (2, 'FLEX'), (3, 'FLEX Speaking'), (4, 'TOEIC'), (5, 'TOEIC Speaking'), (6, 'TOEFL'), (7, 'IELTS'), (8, 'OPIc'), (9, 'Foreign Language Certification Replacement')], default=1)),
            ],
        ),
    ]
